...
object ArcadeBroadcast
{
    ...
    fun publish(broadcasterName: String, gameDisplay: String)
    {
        QuickAccess.sendGlobalFancyBroadcast(
            fancyMessage = render(broadcasterName, gameDisplay),
            permission = null
        )
    }

    fun render(broadcaster: String, game: String): FancyMessage = FancyMessage()
        .withMessage(" \n")
        ...
        .andCommandOf(ClickEvent.Action.RUN_COMMAND, "/joinqueue arcade")
        .withMessage(" ")
}
